...
data = {"id": 3, "slot": "Slot Malam", "wib_schedule": "20:23 WIB", "topic_title": "Zombie Cordyceps Fungus & Bullet Ant", "youtube_title": "The Real-Life Zombie Parasite of the Amazon 🐜🍄 #nature #wildlife #amazon #parasite", "hook_sentence": "Deep in the Amazon rainforest, a real-life zombie infection turns ants into puppets.", "script_lines": ["When a microscopic Cordyceps spore lands on a foraging ant, it doesn't kill the body immediately.", "It grows invasive fungal networks directly into the ant's muscle fibers, taking full control of its nervous system.", "The infected ant is chemically forced to abandon its colony and climb high onto a plant stem facing the sun.", "In its final moments, it clamps its mandibles into the main leaf vein in a permanent, locked death grip.", "Days later, a fungal stalk bursts violently out of the back of the ant's head.", "High above the forest floor, it releases millions of infectious spores, showering down on the unsuspecting colony below.", "This terrifying biological takeover inspired video games and shows why nature is stranger than fiction."], "search_keyword": "ant rainforest macro insect", "youtube_description": "Nature holds secrets more terrifying than science fiction. In the dense canopy of the Amazon rainforest, Ophiocordyceps unilateralis—the infamous 'zombie-ant fungus'—takes complete control of its host. Rather than killing the ant right away, fungal mycelium infiltrates the insect's muscles, hijacking its motor control.\n\nThe hijacked ant is chemically compelled to climb to the exact microclimate height of 25 centimeters above the forest floor, align with the sun, and lock its jaws onto the underside of a leaf. Once anchored, the fungus consumes the ant's internal organs and sprouts a fruiting body directly through the ant's head to rain spores onto the colony below.\n\nSubscribe to @4kscenicwildlife for mind-blowing 4K nature documentaries, bizarre animal facts, and breathtaking wildlife cinematography from every corner of Earth!\n\n#Cordyceps #ZombieAnt #NatureDocumentary #AmazonRainforest #Insects #Parasite #4KNature #BizarreNature #ScienceShorts #ScenicWildlife", "youtube_tags": ["cordyceps", "zombie ant", "amazon rainforest", "nature documentary", "4k nature", "parasitic fungus", "bizarre animals", "insect behavior", "nature facts", "4kscenicwildlife"]}
