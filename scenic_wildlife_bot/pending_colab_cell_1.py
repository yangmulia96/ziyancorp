...
data = {"id": 1, "slot": "Slot Siang", "wib_schedule": "10:34 WIB", "topic_title": "Peregrine Falcon 390 KM/H Stoop Dive", "youtube_title": "The 390 KM/H Sky Hunter That Shatters Physics 🦅💨 #wildlife #nature #falcon #shorts", "hook_sentence": "Imagine diving out of the sky at nearly four hundred kilometers per hour—fast enough to pop human lungs.", "script_lines": ["High above the clouds, the peregrine falcon locks its telescopic vision on a target below.", "As it folds its razor-sharp wings, gravity takes over and it accelerates into a supersonic bullet.", "At three hundred and ninety kilometers per hour, ordinary nostrils would violently burst from air pressure.", "But nature equipped this master raptor with specialized aerodynamic baffles inside its nose to breathe at lethal speeds.", "A third clear eyelid acts as specialized aviation goggles to maintain crystal clear sight.", "It strikes its prey mid-air with a clenched fist delivering the impact force of a high-velocity cannon.", "This unmatched aerial mastery makes the peregrine falcon the fastest creature to ever live."], "search_keyword": "falcon bird flying sky", "youtube_description": "Did you know that the fastest animal on Earth doesn't run on land—it dives from the sky? The Peregrine Falcon reaches unbelievable speeds exceeding 390 km/h (240 mph) during its lethal hunting stoop. At these extreme velocities, air pressure would instantly rupture human lungs, but the falcon evolved specialized aerodynamic baffles inside its nostrils to regulate airflow. Combined with a third protective eyelid and reinforced bone structure, it strikes mid-air prey with the force of a bullet.\n\nExplore the unbelievable power, speed, and precision of nature with us.\n\nSubscribe to @4kscenicwildlife for daily 4K documentary shorts showcasing the world's most incredible animals!\n\n#PeregrineFalcon #WildlifeDocumentary #4KNature #BirdsOfPrey #FastestAnimal #NatureFacts #WildlifeLovers #EpicNature #ScenicWildlife #Shorts", "youtube_tags": ["peregrine falcon", "fastest animal", "wildlife documentary", "4k nature", "birds of prey", "hunting stoop", "falcon speed", "nature facts", "animal superpowers", "4kscenicwildlife"]}
